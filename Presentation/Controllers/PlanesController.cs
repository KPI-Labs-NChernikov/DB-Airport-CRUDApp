...
namespace Presentation.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public PlanesController(IPlaneService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Create(PlaneModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, PlaneModel model)
        {
            if (!ModelState.IsValid)
                return View(model);
            model.Id = id;
